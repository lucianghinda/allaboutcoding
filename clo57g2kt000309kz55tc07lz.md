...
I used one single type of callback on `save`. But you in each solution how you can make it work for all callbacks.
...
## Solution 2: Patching `ApplicationRecord` to allow removing all callbacks
...
### Solution 3: Put the custom code in .`irbrc`
